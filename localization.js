(() => {
  ...
  const UI_ROWS = [
    ...
    ["Đang tải lịch sử thay đổi…", "正在加载更新…", "変更履歴を読み込み中…", "변경 내역을 불러오는 중…"],
    ["Xem lịch sử thay đổi", "查看更新日志", "変更履歴を見る", "변경 내역 보기"],
    ["Chưa có thay đổi nào được công bố.", "暂无已发布的更新。", "公開済みの変更はありません。", "게시된 변경 사항이 없습니다."],
